...
class BoolControlWidget extends StatefulWidget {
  ...
  @override
  BoolControlWidgetState createState() => BoolControlWidgetState();
}

class BoolControlWidgetState extends State<BoolControlWidget> {
  late bool value;
...
class NumberControlWidget extends StatefulWidget {
  ...
  @override
  NumberControlWidgetState createState() => NumberControlWidgetState();
}

class NumberControlWidgetState extends State<NumberControlWidget> {
  late double value;
